...
const ImpactPage = () => {
  return (
    <section className="py-20 md:py-28 bg-primary text-primary-foreground relative overflow-hidden pt-16"> {/* Added pt-16 */}
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6"> {/* Changed h2 to h1 */}
            Transforming
