      ...
      <div className="container mx-auto px-4 relative z-10 text-center"> {/* Added text-center */}
        <div className="max-w-3xl mx-auto"> {/* Max-width and auto margins for centering */}
          <div> {/* This was the 'Left Column - Content' */}
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-xl mx-auto"> {/* Added max-w-xl mx-auto */}
            ...
            <div className="bg-muted/50 rounded-2xl p-6 border border-border/50 mb-8 max-w-lg mx-auto"> {/* Added max-w-lg mx-auto */}
              <div className="flex items-start gap-4 text-left"> {/* Added text-left */}
