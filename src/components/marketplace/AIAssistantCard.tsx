...
import { Bot, Sparkles, MessageSquare, ArrowRight, Apple, Heart, Wallet } from "lucide-react";
      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <Button onClick={nextTip} variant="outline" size="sm" className="flex-1 gap-2 rounded-xl">
              Next Tip
            </Button>
            <Button size="sm" className="flex-1 gap-2 rounded-xl bg-secondary text-secondary-foreground hover:bg-secondary/90">
