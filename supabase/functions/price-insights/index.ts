...
serve(async (req) => {
  ...
  try {
    ...
    const GEMINI_API_KEY = Deno.env.get("GEMINI_API_KEY_MARKET") || Deno.env.get("GEMINI_API_KEY");
    if (!GEMINI_API_KEY) throw new Error("GEMINI_API_KEY or GEMINI_API_KEY_MARKET is missing");
